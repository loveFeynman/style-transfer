...
def train_style_network():
    ...
    loss, style_loss, content_loss, total_var_loss = StyleTransfer.total_loss(style_network_output, style_target_placeholder, content_target_placeholder, style_layers, content_layers)
...
def normal_style_transfer():
    ...
    train_target = tf.Variable(content_image_1, name='train_target')
